...
class DenseNet3D(nn.Module):
    ...
    """
    def __init__(self, num_demographics, growth_rate=16, num_dense_layers=[4, 4], initial_filters=32, transition_filters_multiplier=2, use_se_blocks=False, use_dropout=True):
